...
您需要将其保存为：`/usr/share/wayland-sessions/treeland-plain.desktop`。下一次便可以选择`treeland-plain`会话进入。
...
您需要将其保存为：`/usr/share/wayland-sessions/gxde-treeland.desktop`。下一次便可以选择`gxde-treeland`会话进入。
